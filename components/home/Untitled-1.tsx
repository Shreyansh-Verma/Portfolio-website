...
const HeroSection: React.FC = () => {
  ...
  //   tl.to('.intro-image img', { y: '-120%' }, '-=0.5');
...
const HERO_STYLES = {
  ...
  return (
    <div className={HERO_STYLES.SECTION} style={{backgroundColor:"black"}}>
      <div className="intro-text">
        <h1 className = "text-4xl seq">Welcome to My Website</h1>
        <p>I am a proud NIDIAN.</p>
      </div>
      <div className="intro-image" style = {{opacity:0}}>
        <img src="/1.jpg" alt="Intro" />
      </div>
    </div>
  );
};
