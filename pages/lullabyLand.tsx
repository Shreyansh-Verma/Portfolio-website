...
const LullabyLand = ()=>{
    ...
    {isLoading ? (
            ...
            <Header/>                                                                                                                                                                                                                                          
            <div style = {{}}>
                <img style = {{height:"100%",width:"100%"}} src="/projects/lullabyLand/page1.png"></img>
                <img style = {{height:"100%",width:"100%"}} src="/projects/lullabyLand/page2.gif"></img>
                <img style = {{height:"100%",width:"100%"}} src="/projects/lullabyLand/page3.png"></img>
                <img style = {{height:"100%",width:"100%"}} src="/projects/lullabyLand/page4.gif"></img>
            </div>
            </>
        )}
        </>                                                                                                                                                                                                                                                                                                         
